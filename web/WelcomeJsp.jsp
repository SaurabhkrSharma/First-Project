...
<html>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="link/bootstrap.min.js"></script>
    ...
    <script>
                window.alert("Now You Are Successfully Logged in With Admin");
                </script>
...
%></center></strong>
    ...
    <br><br><br><br><br>
        ...
        <input type="Submit" class="btn btn-primary btn-lg" value="Add Teacher">
                        </form>
        </div>
        ...
        <input type="Submit" class="btn btn-primary btn-lg" value="View Teacher">
         </form>
        </div>
        ...
        <input type="Submit" class="btn btn-primary btn-lg" value="View Student">
         </form>
        </div>
               <br><br><br><br><br><br>
