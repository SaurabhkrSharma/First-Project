<%-- 
    Document   : Hobby
    Created on : Jul 2, 2018, 12:37:22 PM
    Author     : SAURABH
--%>
...
<abbr title="Enter Your Name"><input type="text" placeholder="Name" id="sel" class="form-control input-lg" required><br><br></abbr>
                    </div>
  </div>
  <div class="form-group">
                    <div class="col-xs-7">
...
<abbr title="Enter Your Mobile No."><input type="Number" placeholder="Mobile" id="sel3" class="form-control input-lg" required/><br><br></abbr>
    ...
    <div class="form-group">
                    <div class="col-xs-7">
                        <label for="4">Enter your Location :</label><br>
...
<select class="form-control input-lg" id="sel5">
    <option value="Hobby">Select Your Hobby</option>
...
<input type="submit" class="btn btn-default btn-lg" value="Submit"/><br><br>
                    </div>
    </div>
</div>
</form>    </body>
