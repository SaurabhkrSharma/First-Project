<%-- 
    Document   : Teacher
    Created on : Jul 3, 2018, 3:06:20 PM
    Author     : SAURABH
--%>
...
<hr>
    ...
    <center> 
                     <div class="navbar navbar-inverse">
                         ...
                         <li class="active"><a href="Teacher.jsp"><i class="fa fa-fw fa-user-circle-o fa-lg"></i>Teacher</a></li>
          ...
          <button class="btn btn-default" type="submit">
              <i class="glyphicon glyphicon-search" style="width: 20px; height: 20px;"></i>
                  ...
                  <div class="container">
                      ...
                      <form action="TeacherLogin" method="post" class="form-horizontal">
           <div class="form-group">
               <label class="control-label col-sm-4" for="usr" >Username</label>
               <div class="col-sm-4">
                   <input type="text" class="form-control" id="usr" name="name" placeholder="Enter Username" required>
               </div>
           </div>
           <div class="form-group">
           ...
           <div class="col-sm-14">
             <input type="submit" class="btn btn-default" style="width: 15%" value="Login" >
