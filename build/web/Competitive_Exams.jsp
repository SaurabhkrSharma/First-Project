<%-- 
    Document   : Competitive_Exams
    Created on : Jul 2, 2018, 12:36:59 PM
    Author     : SAURABH
--%>
...
<abbr title="Enter Your Mobile No."><input type="Number" placeholder="Mobile" class="form-control input-lg" id="sel3" required/><br><br></abbr>
    </div>
</div>
<div class="form-group">
    <div class="col-xs-7">
        <label for="sel4">Enter your Location :</label><br>
<abbr title="Enter Your Location."><input type="text" placeholder="Location" class="form-control input-lg" id="sel4" required/><br><br></abbr>
    </div>
</div>
<div class="form-group">
    <div class="col-xs-7">
